SCENE_DIR="$HOME/data/bad-gaussian/data/bad-nerf-gtK-colmap-nvs"
RESULT_DIR="results/benchmark_mcmc_500k/badnerf_synthetic_linear"
SCENE_LIST="blurcozy2room blurfactory blurpool blurtanabata blurwine roomblur_low roomblur_high"
