SCENE_DIR="$HOME/data/bad-gaussian/data/Deblur-GS/synthetic_release"
RESULT_DIR="results/benchmark_mcmc_500k/exblurf_synthetic_linear"
SCENE_LIST="blurcozy2room blurfactory blurpool blurtanabata blurwine"
